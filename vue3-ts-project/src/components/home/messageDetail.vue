    ...
    <el-container>
      ...
      <el-aside width="200px">
        ...
        <div class="publish-msg">
          发布人：{{ messageInfo.message_publish_name }}
        </div>
        ...
        <div class="publish-msg" v-if="title.value == '公司公告'">
          ...
          <el-tag
            class="mx-1"
            round
            v-if="messageInfo.message_level == '一般'"
            >{{ messageInfo.message_level }}</el-tag
          >
          <el-tag
            type="warning"
            class="mx-1"
            round
            v-if="messageInfo.message_level == '重要'"
            >{{ messageInfo.message_level }}</el-tag
          >
          <el-tag
            type="danger"
            class="mx-1"
            round
            v-if="messageInfo.message_level == '必要'"
            >{{ messageInfo.message_level }}</el-tag
          >
        </div>
        <div class="publish-msg">
...
const messageInfo: messageData = reactive({
  message_title: "",
  message_content: "",
