...
const superAdminRouter = [
  ...
  },
  {
    ...
    path: "/overview",
    meta: { title: "系统概览" },
    component: "menu/overView",
  },
  {
    name: "product_manage",
    path: "/product_manage",
    meta: { title: "产品管理员" },
    component: "menu/userManage/productManage",
  },
  {
    name: "message_manage",
    path: "/message_manage",
    meta: { title: "消息管理员" },
    component: "menu/userManage/messageManage",
  },
  {
    name: "user_list",
    path: "/user_list",
    meta: { title: "用户列表" },
    component: "menu/userManage/userList",
  },
  {
    name: "user_manage",
    path: "/user_manage",
    meta: { title: "用户管理" },
    component: "menu/userManage/userManage",
  },
  {
    name: "inProduct",
    path: "/inProduct",
    meta: { title: "产品管理" },
    component: "menu/productManage/inProduct",
  },
  {
    name: "outProduct",
    path: "/outProduct",
    meta: { title: "出库管理" },
    component: "menu/productManage/outProduct",
  },
  {
    name: "messageList",
    path: "/messageList",
    meta: { title: "消息管理" },
    component: "menu/messageManage/messageList",
  },
  {
    name: "messageRecycle",
    path: "/messageRecycle",
    meta: { title: "回收站" },
    component: "menu/messageManage/messageRecycle",
  },
  {
    name: "file",
    path: "/file",
    meta: { title: "文件管理" },
    component: "menu/contract/file",
  },
  {
    name: "operation_log",
    path: "/operation_log",
    meta: { title: "操作日志" },
    component: "menu/log/operation_log",
  },
  {
    name: "Login_log",
    path: "/Login_log",
    meta: { title: "登录日志" },
    component: "menu/log/Login_log",
  },
];
...
const userAdminRouter = [
  ...
  },
  {
    ...
    path: "/file",
    meta: { title: "文件管理" },
    component: "menu/contract/file/index",
  },
];
// 产品管理员路由
